    ...
    public void press(Button bu)
    {
        switch (bu.ToString())
        {
            ...
            case ("Button (4) (UnityEngine.UI.Button)"):
                {
                    CharacterData.Instance.MyCharacter.Add(5);
                    break;
                }
            case ("Button (5) (UnityEngine.UI.Button)"):
                {
                    CharacterData.Instance.MyCharacter.Add(6);
                    break;
                }
            case ("Button (6) (UnityEngine.UI.Button)"):
                {
                    CharacterData.Instance.MyCharacter.Add(7);
                    break;
                }
            case ("Button (7) (UnityEngine.UI.Button)"):
                {
                    CharacterData.Instance.MyCharacter.Add(8);
                    break;
                }
            case ("Button (8) (UnityEngine.UI.Button)"):
                {
                    CharacterData.Instance.MyCharacter.Add(9);
                    break;
                }
            case ("Button (9) (UnityEngine.UI.Button)"):
                {
                    CharacterData.Instance.MyCharacter.Add(10);
                    break;
                }
